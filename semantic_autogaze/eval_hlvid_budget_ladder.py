...
BUDGETS = [
    ...
    {"name": "scaled 0.75 tile=0.150 thumb=0.5625", "tile": 0.150, "thumb": 0.5625},
    {"name": "scaled 0.72 tile=0.144 thumb=0.5400", "tile": 0.144, "thumb": 0.5400},
    {"name": "scaled 0.70 tile=0.140 thumb=0.5250", "tile": 0.140, "thumb": 0.5250},
    {"name": "scaled 0.68 tile=0.136 thumb=0.5100", "tile": 0.136, "thumb": 0.5100},
    {"name": "scaled 0.65 tile=0.130 thumb=0.4875", "tile": 0.130, "thumb": 0.4875},
]
...
if __name__ == "__main__":
    ...
    p.add_argument("--output_dir", default="results/budget_ladder_fine_grained")
    args = p.parse_args()
    main(args)
